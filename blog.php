...
<!-- MAIN -->
<main class="page page_blog" data-barba="container" data-barba-namespace="blog">
  <section class="page-heading">
    <div class="page-heading__container">
      <a href="javascript:void(0)" class="page-heading__button">
        ...
        Назад</a>
      <h1 class="page-heading__title">Блог</h1>
    </div>
  </section>
  <section class="blog">
    <div class="blog__container">
      <ul class="blog__filter blog-filter">
        <li class="blog-filter__list-item"><button type="button" class="blog-filter__button _active">Всі</button></li>
        <li class="blog-filter__list-item"><button type="button" class="blog-filter__button">Статті</button></li>
